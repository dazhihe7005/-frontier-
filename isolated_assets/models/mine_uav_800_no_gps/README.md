...
The STEP-derived vertical bounds are `z=-0.2718..+0.1610 m` in the simulated
FLU frame. Two non-rolling 0.40 m landing-rail collisions at `y=+/-0.18 m`
support the aircraft at the measured lower structure instead of its centre
body. This is important on the rough tunnel mesh: belly contact produced large
stationary accelerometer impulses and intermittent PX4 height-estimator drift.
